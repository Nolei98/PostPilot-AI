...
- image_prompt: em INGLÊS, descreve uma cena SEM TEXTO (o hook é sobreposto depois), enquadrada para vertical 4:5 (feed do Instagram) — assunto principal centralizado, sem detalhes importantes perto das bordas de cima/baixo. Estilo FOTOGRÁFICO REALISTA tipo foto documental/editorial de marketing: câmera de verdade, luz natural, textura real de pele com poros e imperfeições sutis, expressão natural, leve grão de filme. NUNCA use ou sugira: "3d render", "illustration", "cartoon", "perfect symmetry", "smooth/plastic skin", "oversaturated", "studio stock photo", cores neon saturadas, glow artificial, simetria perfeita — são os termos/estilos que denunciam IA. Termine SEMPRE com, nesta ordem exata: "vertical 4:5 portrait aspect ratio (1080x1350), candid documentary photograph, shot on camera, 85mm lens, shallow depth of field, natural window light, realistic skin texture with visible pores, muted natural color grading, fine film grain, photorealistic, no CGI look, no AI-art look". O aspect ratio precisa vir escrito no prompt final porque ele também é colado manualmente em apps de geração (Gemini/nano banana) que não recebem parâmetro de tamanho separado — só o texto.`,
    messages: [
      {
        role: "user",
