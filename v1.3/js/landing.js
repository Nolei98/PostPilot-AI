/* ==========================================================================
   PostPilot AI v1.3 - Landing Page Motion Scrollytelling Logic (GSAP)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- 3D Hover Tilt Effect for Resource Cards ---
  ...
  if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
    ...
    if (!prefersReducedMotion) {
      ...
      gsap.set(floatAirplane, { x: -80, y: 150, opacity: 0, scale: 0.5, rotate: 10 });
      ...
      // --- STORYBOARD MASTER CHOREOGRAPHY ---
      
      // ATO 1 — ENTRADA (0% to 15%)
      masterTimeline
        .to(phoneWrap, { 
        ...
        // ATO 2 — DA NOTÍCIA AO POST (15% to 38%)
        ...
        // Fly paper airplane tridimensionally across the scene
        .to(floatAirplane, { 
          x: 380, y: -180, scale: 1.6, rotate: 45, opacity: 1, duration: 0.5, ease: "sine.out" 
        }, 1.1)
        .to(floatAirplane, { 
          x: 520, y: -300, scale: 0.8, opacity: 0, duration: 0.4, ease: "sine.in" 
        }, 1.6)
